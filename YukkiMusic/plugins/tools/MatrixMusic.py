...
@app.on_message(filters.command("ماتركس نادي المطور", [".", ""]) & filters.group)
async def kstr(client: Client, message: Message):
       ...
       await message.reply_text(
        f"""- ابشر ياعيوني ارسلت للمطور يدخل القروب ويشوف مشكلتك بأقرب وقت\n\n- تابع قناة البوت عشات تشوف التحديثات -› [• 𝖬𝖺𝖳𝗋𝗂x 𝖳𝖾𝖠𝗆 •](t.me/XMATTMX)""", disable_web_page_preview=True
    )
...
@app.on_message(filters.regex("^ماتركس$"))
...
async def down(client, message):
          m = await message.reply("**- ابشر تم اخفاء الازرار بنجاح\n- لو تبي تطلعها مرة ثانية اكتب ماتركس**", reply_markup= ReplyKeyboardRemove(selective=True))


@app.on_message(filters.group & command("‹ كيفية استخدام ماتركس ›"))
async def addbot(client: Client, message: Message):
    await message.reply_text(f"""- **هلا والله ياعيني عشان تفعل بوت ماتركس اتبع الخطوات الي بالاسفل**
1 • ارفعه مشرف بكل الصلاحيات 
2 • لو تبي تشوف الاوامر اكتب [ م الاوامر ] ولو تبي تشغل على طول اكتب شغل + اسم المقطع الصوتي
• مثال : شغل واتنسيت
- لو واجهت مشكله كلم مطور البوت ~ @RNRYR""",
        reply_markup=InlineKeyboardMarkup(
            [
                [
                    InlineKeyboardButton(
                       "• 𝖣𝖾𝗏𝖾𝗅𝗈𝗉𝖾𝗋 •", user_id=6373798952),
                ],[
                    InlineKeyboardButton(
                        "• اضف البوت الى مجموعتك •", url=f"https://t.me/MaTrix_MusicBoT?startgroup=true"),
                ],
            ]
        ),
...
async def addbot(client: Client, message: Message):
    await message.reply_text(f"""**- اهلين فيك بسورس ماتركس
• لو تبي تنصب مثل هالبوت تواصل مع مطور السورس
• عندك استفسار او اقتراح بخصوص البوت تواصل مع مطور البوت**
مطور السورس -› [🥡 | 𝖠𝗁𝗆𝖾𝖽 | 🥡](t.me/RNRYR)
قناة السورس -› [🥡 | 𝖬𝖺𝖳𝗋𝗂x 𝖳𝖾𝖠𝗆| 🥡](t.me/XMATTMX)
""",
        reply_markup=InlineKeyboardMarkup(
            [
                [
                    InlineKeyboardButton(
                        "• 𝖤x𝗉 𝖬𝖺𝖳𝗋𝗂x •", url=f"https://t.me/XMATTMX"),
                ],[
                    InlineKeyboardButton(
                        "• اضف البوت الى مجموعتك •", url=f"https://t.me/MaTrix_MusicBoT?startgroup=true"),
                ],
...
REPLY_MESSAGEE = "- هلا فيك في قسم اوامر ماتركس"
...
@app.on_message(filters.group & command("‹ اوامر ماتركس ›"))
...
• AppleMusic
• Spotify
- لو واجهت مشكلة تواصل مع مطور السورس @RNRYR**
- [‹ 𝖬𝖺𝖳𝗋𝗂x 𝖳𝖾𝖠𝗆 ›](t.me/XMATTMX)
""",
        reply_markup=InlineKeyboardMarkup(
            [
                [
